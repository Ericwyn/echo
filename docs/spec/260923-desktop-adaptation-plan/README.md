...
| P5 | Linux `1.1.0+2055` DEB 与 bundle ZIP、Android ARM64 APK 已构建 | `b0bc5800` 在全新 `build/linux-lldtmp-2066` 构建；DEB SHA-256 `74d9feab40b44be90a6ed55da5d86af9055962726cba3811b757bca4469f2bab`，standalone bundle ZIP SHA-256 `9ac20a4b0262ea9ed6ac3d7315fa94cb6f904d77204939f0cb25c818cde31399`，归档完整性通过；DEB 声明 GTK、Ayatana AppIndicator、libmpv 运行依赖，`dpkg` 确认 2055 高于上一 Linux 包 2054。Android 本机签名 ARM64 APK 仍为 versionCode `2054`，高于用户设备版本 `2026`，仅含 `arm64-v8a`，签名及包信息校验通过。产物未安装或启动；紧凑播放条和性能验收仍由用户执行；Windows CI 暂缓。最新 Linux 证据：[紧凑播放控制构建](evidence/260924-compact-playback-controls/README.md) |
