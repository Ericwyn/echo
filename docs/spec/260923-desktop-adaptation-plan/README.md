...
| P5 | 当前 Linux `1.1.0+2053` bundle/.deb 与 Android arm64 APK 均已构建 | 最新 Linux bundle 在 `build/linux-lldtmp-2057` 全新 build-dir 编译；Debian 包版本 `1.1.0+2053`、amd64，SHA-256 `aa9425eb00b6b594e515b638ea894ce30bb40c789ef849bf2caa1698bf5fd20a`。Android 本机签名 ARM64 APK versionCode `2047`，仅含 `arm64-v8a`，证书校验通过，SHA-256 `08e74d6e98d2a966db2d77b598da3ea6ff53b1c40ed45013be8dd0ebacf8a8f3`。产物未安装或启动；用户仍需验收音乐库管理、Ubuntu 桌面行为、Android 后台播放与性能；Windows CI 暂缓。最新证据：[MPRIS 合约构建](evidence/260924-mpris-contract-build/README.md) |
