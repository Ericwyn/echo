...
| P5 | 当前 Linux `1.1.0+2053` bundle/.deb 与 Android arm64 APK 均已构建 | 最新 Linux bundle 在 `build/linux-lldtmp-2056` 全新 build-dir 编译；Debian 包版本 `1.1.0+2053`、amd64，SHA-256 `d58f35c216d466700a5c7f3c51bf30672ad6462e90ca92330b6f1e378d6821b5`。Android 本机签名 ARM64 APK versionCode `2046`，仅含 `arm64-v8a`，证书校验通过，SHA-256 `c75a4cc44c69e2aa91125f16b5eb32117504be92e0ebf3e47ed1b0009a1eaa2d`。产物未安装或启动；用户仍需验收音乐库管理、Ubuntu 桌面行为、Android 后台播放与性能；Windows CI 暂缓。最新证据：[路由状态恢复构建](evidence/260924-route-scroll-restore-build/README.md) |
