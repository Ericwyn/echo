...
| P5 | 当前 Linux `1.1.0+2053` bundle/.deb 与 Android arm64 APK 均已构建 | 最新 Linux bundle 在 `build/linux-lldtmp-2058` 全新 build-dir 编译；Debian 包版本 `1.1.0+2053`、amd64，SHA-256 `3a5b7363c291492ebfda10cb165eea95f34f16a2daa50e14001e54629e8ea5ab`。Android 本机签名 ARM64 APK versionCode `2048`，仅含 `arm64-v8a`，证书校验通过，SHA-256 `00bfd0772d6d88d126b6c9690af753b49be2dc44537967adb8a49f251aba552b`。产物未安装或启动；用户仍需验收音乐库管理、Ubuntu 桌面行为、Android 后台播放与性能；Windows CI 暂缓。最新证据：[托盘恢复竞态构建](evidence/260924-tray-host-hide-race-build/README.md) |
