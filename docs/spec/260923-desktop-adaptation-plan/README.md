...
| P5 | Linux `1.1.0+2053` DEB 与 bundle ZIP、Android ARM64 APK 已构建 | Linux lifecycle recovery commit `9abb3e09` 在 `build/linux-lldtmp-2064` 构建；DEB SHA-256 `ab02302777cf8d9b94b9baebbb2ff053441be3e57978cb3bee3022dfbc6fc349`，standalone bundle ZIP SHA-256 `69417c0ef87a1f4630328a95a1b06ad8694d5b4ec19ee8327ecd42e72232f4b2`，归档完整性通过；DEB 声明 GTK、Ayatana AppIndicator、libmpv 运行依赖，当前主机静态 ELF 依赖检查无缺失。Android 本机签名 ARM64 APK versionCode `2054`，仅含 `arm64-v8a`，证书校验通过。产物未安装或启动；手动与性能验收仍由用户执行；Windows CI 暂缓。最新 Linux 证据：[生命周期恢复构建](evidence/260924-linux-lifecycle-recovery/README.md) |
