...
| P5 | 当前 Linux `1.1.0+2053` bundle/.deb 与 Android arm64 APK 均已构建 | 删除音乐库后的桌面历史修复在 `build/linux-lldtmp-2061` 全新 build-dir 编译；Debian 包版本 `1.1.0+2053`、amd64，DEB SHA-256 `1a2537c13606144a0b55c11d6bdffe04f5c486b8628f5792c68f5b58097af119`；独立 Linux bundle ZIP SHA-256 `1ba2dd3399b223c0b8f481a58d97f437d40901572fbbac5d869cdc3909286ea9`，完整性检查通过。Android 本机签名 ARM64 APK versionCode `2051`，仅含 `arm64-v8a`，证书校验通过，SHA-256 `4b53b3c8414ac701a950706aa783b6e5a416f503284bdf1c2bfbfc60463b2a77`。产物未安装或启动；用户仍需验收音乐库删除、Ubuntu 桌面行为、Android 后台播放与性能；Windows CI 暂缓。最新证据：[音乐库删除历史修复构建](evidence/260924-library-delete-history-build/README.md) |
