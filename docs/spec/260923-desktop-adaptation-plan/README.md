...
| P5 | 当前 Linux `1.1.0+2053` bundle/.deb 与 Android arm64 APK 均已构建 | 统一播放命令后的 Linux release 在 `build/linux-lldtmp-2062` 构建；DEB SHA-256 `f7d6e9f3ffe9bd44a59841628ef322bbe0aca17526e7341deb0b15c8cfdc742f`，standalone bundle ZIP SHA-256 `7e06b94cf5ba7128b8ffc964ef5fff65838267cba1815d1aeade132e715bcbc9`，完整性检查通过。Android 本机签名 ARM64 APK versionCode `2053`，仅含 `arm64-v8a`，证书校验通过，SHA-256 `3626dfd31c0b7bd364618d78e23cfc6b04afbc8970110188af55f16506605ed5`。产物未安装或启动；手动与性能验收仍由用户执行；Windows CI 暂缓。最新证据：[共享播放命令统一构建](evidence/260924-playback-command-unification-build/README.md) |
