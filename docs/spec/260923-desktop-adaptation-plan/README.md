...
| P5 | Linux `1.1.0+2056` DEB 与 bundle ZIP、Android ARM64 APK 已构建 | `5f0f429d` 在全新 `build/linux-lldtmp-2067` 构建；DEB SHA-256 `fc9a06eaa2bc093a10afbf725fc0585c92fce1899b47af61c4ed314d7369ecdb`，standalone bundle ZIP SHA-256 `c125bb72c9708ea3aaf79e9167236c30d2312f6bdc7692f5dd4e9d5f24902fc0`，归档完整性通过；DEB 声明 GTK、Ayatana AppIndicator、libmpv 运行依赖，`dpkg` 确认 2056 高于上一 Linux 包 2055。Android 本机签名 ARM64 APK 仍为 versionCode `2054`，高于用户设备版本 `2026`，仅含 `arm64-v8a`，签名及包信息校验通过。产物未安装或启动；紧凑播放菜单和性能验收仍由用户执行；Windows CI 暂缓。最新 Linux 证据：[紧凑播放菜单构建](evidence/260924-compact-playback-menu/README.md) |
