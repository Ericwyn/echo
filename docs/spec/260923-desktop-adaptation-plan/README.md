...
| P5 | Linux `1.1.0+2053` DEB 与 Android ARM64 APK 已构建 | Linux lifecycle recovery commit `0e832ddb` 在 `build/linux-lldtmp-2064` 构建；DEB SHA-256 `f6e7b48e190b0cb3e696dbd57bc0a5ef875fc09f9357a2cc3d4a028e76b58450`。此前 `c4bd0b6e` standalone bundle ZIP SHA-256 `5de9a27a5d1be3e15e3540d2750cb932c3f365e9e16c91dfd88f2bbd`，完整性检查通过。Android 本机签名 ARM64 APK versionCode `2054`，仅含 `arm64-v8a`，证书校验通过。产物未安装或启动；手动与性能验收仍由用户执行；Windows CI 暂缓。最新 Linux 证据：[生命周期恢复构建](evidence/260924-linux-lifecycle-recovery/README.md) |
