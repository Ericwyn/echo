...
| P5 | 当前 Linux `1.1.0+2053` bundle/.deb 与 Android arm64 APK 均已构建 | 最新 Linux bundle 在 `build/linux-lldtmp-2060` 全新 build-dir 编译；Debian 包版本 `1.1.0+2053`、amd64，SHA-256 `ae3fd50bf02c758f663cd2fd5f41c3b935eb1d116299a87e31802f0f91bd8281`。Android 本机签名 ARM64 APK versionCode `2050`，仅含 `arm64-v8a`，证书校验通过，SHA-256 `f6869a539a4e11693441bb9edafce7918a4c5afebc096ce1d9eccc2dd8063f5f`。产物未安装或启动；用户仍需验收音乐库管理、Ubuntu 桌面行为、Android 后台播放与性能；Windows CI 暂缓。最新证据：[生命周期恢复策略构建](evidence/260924-lifecycle-recovery-policy-build/README.md) |
