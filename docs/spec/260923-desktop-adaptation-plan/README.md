...
| P5 | Linux `1.1.0+2058` DEB/bundle ZIP 与 Android ARM64 APK 已构建 | app bundle 由 `24e5319e` 在全新 `build/linux-lldtmp-2069` 编译；`818239ea` 的打包脚本生成 `build/linux-lldtmp-2072/packages/` 中 DEB 和 bundle ZIP。DEB SHA-256 `8dd62dd8b7ceeaf736aa67d845f4fe763991e5ce16a496b2a195f25095028486`，ZIP SHA-256 `884489b3c06823e6b116be2fe657661d72b9112af62eab9c8d253a898d74d340`，38 项完整；DEB 依赖 GTK、Ayatana AppIndicator、libmpv，且版本高于 2057。Android 签名 ARM64 APK versionCode `2056`，高于设备版 `2026`；证书/ABI/package metadata 校验通过。产物未安装或启动；Flutter tests/analyze 未运行；Ubuntu 手动验收仍待执行。最新证据：[Linux 可重复打包产物](evidence/260924-linux-repeatable-package-artifacts/README.md) |
