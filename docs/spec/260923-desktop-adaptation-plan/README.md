...
| P5 | Linux `1.1.0+2058` DEB/bundle ZIP 与 Android ARM64 APK 已构建 | `24e5319e` 在全新 `build/linux-lldtmp-2069` 构建；DEB SHA-256 `0475341b788b5aaf52b178e6747bb4d39036ed9bff30080515cbbb1659230efe`，standalone bundle ZIP SHA-256 `884489b3c06823e6b116be2fe657661d72b9112af62eab9c8d253a898d74d340`，归档完整性通过；DEB 依赖为 GTK、Ayatana AppIndicator、libmpv，`dpkg` 确认 2058 高于上一 Linux 包 2057。签名 Android APK versionCode `2056`，高于设备版 `2026`，仅含 `arm64-v8a`，证书及 package metadata 校验通过。两端产物未安装或启动；自动回归和手动验收仍待执行；Windows CI 暂缓。最新证据：[随机与循环并发修正](evidence/260924-playback-mode-serialization/README.md) |
