...
| P5 | 当前 Linux `1.1.0+2053` bundle/.deb 与 Android arm64 APK 均已构建 | 最新 Linux bundle 在 `build/linux-lldtmp-2059` 全新 build-dir 编译；Debian 包版本 `1.1.0+2053`、amd64，SHA-256 `6536ce3349d1669c8db43c3e6e02aed1ee6f36773b570c198521eb94d4fbe3a9`。Android 本机签名 ARM64 APK versionCode `2049`，仅含 `arm64-v8a`，证书校验通过，SHA-256 `a2311a4fd2361b33efd65c52315bd5a211022ac22e5206168ae07ebc72d41b93`。产物未安装或启动；用户仍需验收音乐库管理、Ubuntu 桌面行为、Android 后台播放与性能；Windows CI 暂缓。最新证据：[Wayland 窗口恢复构建](evidence/260924-wayland-window-recovery-build/README.md) |
