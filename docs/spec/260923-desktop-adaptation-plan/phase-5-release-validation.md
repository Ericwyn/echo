...
- 历史包 `build/linux/packages/echoes_1.1.0+26_amd64.deb` 与 `1.1.0+2027/2028/2029/2030` 候选均已被替换。当前最新包为 `build/linux-lldtmp/packages/echoes_1.1.0+2031_amd64.deb`，SHA-256 为 `bf8e03e2484b7cff432a26b6883babb5c72c8da730b2d33956307fd4a15da1a5`；`dpkg-deb` 检查通过，仍未安装验证。干净系统播放依赖仍待 CI/Ubuntu 实机记录。
